...
public class EmployeeDataProcessorUpdated {
    ...
    public static void main(String[] args) {
        ...
        displayEmployeesWithLambda(employees);
        getEmployeeNamesWithMethodReference(employees);
        filterHighPaidDevelopers(employees);
        getDepartmentAverageSalary(employees);
        getSalaryStatistics(employees);
